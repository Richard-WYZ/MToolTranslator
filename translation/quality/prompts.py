...
def quality_prompt_rules() -> str:
    return (
        ...
        "When adjacent hiragana and katakana are merely alternate-script repetitions of the same reading, "
        "translate the meaning once instead of duplicating the Chinese phrase. "
